...
export const routes: IRoute[] = [
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(import('../../../pages/analysis/Purchases'), 600)
        ),
        hide: false,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        path: '/newproducts',
        component: lazy(() =>
            pMinDelay(import('../../../pages/newproducts/NewProducts'), 600)
        ),
        hide: false,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(import('../../../pages/settings/roles/CreateRole'), 600)
        ),
        hide: true,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(import('../../../pages/settings/roles/EditRole'), 600)
        ),
        hide: true,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(import('../../../pages/settings/roles/Role'), 600)
        ),
        hide: true,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(import('../../../pages/settings/users/CreateUser'), 600)
        ),
        hide: true,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(import('../../../pages/settings/users/EditUser'), 600)
        ),
        hide: true,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(import('../../../pages/settings/users/User'), 600)
        ),
        hide: true,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        path: '/passwordreset',
        component: lazy(() =>
            pMinDelay(import('../../../pages/resetpassword/ResetPassword'), 600)
        ),
        hide: true,
        exact: false,
        private: false,
    ...
    },
    {
        ...
        path: '/changelog',
        component: lazy(() =>
            pMinDelay(import('../../../pages/changelog/Changelog'), 600)
        ),
        hide: false,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(import('../../../pages/changelog/ChangelogCreate'), 600)
        ),
        hide: true,
        exact: false,
        private: true,
    ...
    },
    {
        ...
        path: '/marketplaces',
        component: lazy(() =>
            pMinDelay(import('../../../pages/marketplaces/Marketplaces'), 600)
        ),
        hide: false,
        exact: true,
        private: true,
    ...
    },
    {
        ...
        component: lazy(() =>
            pMinDelay(
                import('../../../pages/marketplaces/ozon/GoodsStocks'),
                600
            )
        ),
        hide: true,
