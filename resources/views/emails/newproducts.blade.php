        ...
        <tr>
            <td style="padding-left: 20px; padding-right: 20px;">
                <table border="0" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0; width: 100%;">
                    ...
                    <tr>
                        <td
                            style="padding-top: 0px; padding-bottom: 10px; font-family: Arial, Helvetica, sans-serif; font-size:14px; line-height: 18px; color:#949599;">
        ...
        <tr>
            <td style="padding-left: 20px; padding-right: 20px; padding-bottom: 10px;">
                <table bgcolor="#ffffff" align="center" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding-top: 15px; padding-bottom: 15px; padding-left: 15px; padding-right: 15px;">
                            <!-- <img border="0" width="65" style="display: block;"
                                src="https://picsum.photos/65/50?grayscale" alt=""> -->
                            <img border="0" width="65" style="display: block;"
        ...
        <tr>
            <td style="padding-top: 15px; padding-bottom: 25px; padding-left: 20px; padding-right: 20px;">
                <table border="0" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0; width: 100%;">
                    <tr>
                        <td align="center">
                            <a style="display: inline-block; width: 280px; font-family: Arial, Helvetica, sans-serif; font-weight: 600; font-size: 12px; line-height: 40px; color:#ffffff; text-decoration: none; background-color: #eb5e28; border-radius: 10px;" target="_blank" href={{ asset('newproducts') }}>Перейти к новинкам</a>
                        </td>
                    </tr>
                </table>
            </td>
