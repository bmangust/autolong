...
<body
    style="font-family: Montserrat, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size: 13px; line-height: 1.2; background-color: #f7f8fa; padding-top: 60px;">

<table cellspadding='0' cellspacing='0' border="0" width="600"
    ...
    <tr>
        <td style="padding-bottom: 26px;">
                <span
                    ...
                    <img style="display: block; margin: 0 auto; padding-top: 13px;" src="{{ asset('public/imgs/key.png') }}"
                         alt="key">
                </span>
        </td>
    </tr>
