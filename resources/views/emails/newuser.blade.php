...
<table cellpadding='0' cellspacing='0' border="0" width="600"
    ...
    <tr>
        <th style="padding: 24px 30px 20px 30px;">
            <h1 style="margin: 0; font-size: 18px; font-weight: 600; text-align: left; color: #3a405f;">Создание нового пользователя</h1>
        </th>
    </tr>
    <tr>
    ...
    <tr>
        <td style="padding: 0 30px 15px; color: #949599;">
            Ваш логин: <span style="color: #f44a0e;">UserLogin</span>
        </td>
    </tr>
    <tr>
        <td style="padding: 0 30px 15px; color: #949599;">
            Ваш пароль: <span style="color: #f44a0e;">UserPassword</span>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="padding: 0 30px 32px;">
            <a href="#" style="color: #3a405f; text-decoration: none;">http://autolong.ru</a>
        </td>
    </tr>
</table>
